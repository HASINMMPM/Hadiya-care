        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="#" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="self-start text-2xl font-semibold whitespace-nowrap text-dblue">
                HILAAS
              </span>
              <span className="self-start text-xl font-semibold whitespace-nowrap text-blue">
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 ">
              <li>
                <a
                  href="#"
                  className="block py-2 pr-4 pl-3 text-dblue hover:text-blue duration-200 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 lg:dark:hover:text-regal-blue "
                  aria-current="page"
                >
                  Home
                </a>
